...
<?php if($SITE['lang'] == 'en') { ?>  
	...
	<h3>langtransstr('Informazioni sulla stazione Meteo')</h3> 

	<p>langtransstr('Il sito e la raccolta dati sono gestiti dal programma') <a href="<?php echo $SITE['WXsoftwareURL']; ?>"><?php echo $SITE['WXsoftwareLongName']; ?></a>. La stazione comprende l'anemometro, un pluviometro e un sensore di temperatura/umidità collocati in posizione ottimale al fine di ottenere misure il più accurate possibile.</p>
